...
*** Test Cases ***
Verify_division_name_with_lessthan_2_characters
    ...
    Input Text    xpath://*[@id="division_name"]    aa
    ...
    Wait Until Page Contains    Division Name has to be more than 3 characters.    50
    Close Browser
