...
*** Test Cases ***
Verify_create_division_with_already_existed_division_name
    ...
    Input Text    xpath://*[@id="division_name"]    test_core_division_1
    Wait Until Page Contains Element    xpath://*[@id="division_description"]    50
    Input Text    xpath://*[@id="division_description"]    test_core_division_1 description
    Wait Until Page Contains Element    xpath://*[@id="createDivisionSave"]    50
    Click Element    xpath://*[@id="createDivisionSave"]
    Wait Until Page Contains    Division already available    50
    Close Browser
