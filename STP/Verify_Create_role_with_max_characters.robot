...
*** Test Cases ***
Verify_Create_role_with_max_characters
    ...
    Input Text    id:role_name    tttttttttttttttttttttttttttttttt
    ...
    Sleep    3
    Wait Until Page Contains    Enter valid role.Maximum length is 30 characters.    50
    Close Browser
