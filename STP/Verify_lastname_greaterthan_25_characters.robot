...
*** Test Cases ***
Verify_lastname_greaterthan_25_characters
    ...
    Input Text    id:lastname    aaaaaaaaaaaaaaaaaaaaaaaaaaaaaa
    ...
    Wait Until Page Contains    Lastname is too long.Maximum length is 25 characters    50
    Close Browser
