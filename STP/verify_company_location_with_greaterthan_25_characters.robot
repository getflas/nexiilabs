...
*** Test Cases ***
verify_company_location_with_greaterthan_25_characters
    ...
    Input Text    id=company_account_location    aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa
    ...
    Wait Until Page Contains    Location is too long.Maximum length is 25 characters    50
    Close Browser
