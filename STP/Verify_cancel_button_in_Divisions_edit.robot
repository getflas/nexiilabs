...
*** Test Cases ***
Verify_cancel_button_in_Divisions_edit
    ...
    Sleep    3
    Wait Until Page Contains Element    xpath://*[@id="custom-modal-edit"]/div/div/div[2]/div/button[2]    50
    Click Element    xpath://*[@id="custom-modal-edit"]/div/div/div[2]/div/button[2]
