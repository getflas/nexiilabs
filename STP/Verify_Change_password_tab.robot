...
Verify_Change_password_tab
    ...
    Wait Until Page Contains Element    xpath://*[@id="notification"]/li[7]/ul/li[1]/a    50
    Click Element    xpath://*[@id="notification"]/li[7]/ul/li[1]/a
    Wait Until Page Contains    Change Password    30
    Wait Until Page Contains    Current Password    30
    Wait Until Page Contains    New Password    30
    Wait Until Page Contains    Confirm Password    30
    Close Browser
